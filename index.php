...
<div class="container mt-5 mb-5 d-flex justify-content-center">
    <form action="javascript:void(0);" onsubmit="return FormValidation()" enctype="multipart/form-data">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12 field_margin">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="first_name" placeholder="" value=""> 
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12 field_margin">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="last_name" placeholder="" value=""> 
                    </div>
                ...
                <div class="col-sm-12 field_margin">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" name="dob" id="dob" type="date" placeholder="" data-date="" data-date-format="DD/MM/YYYY"value=""> 
                        </div>
                    </div>
            ...
            <div class="row"style="margin:0px 2px;">
                <label>Upload Your Resume *</label>
                 <fieldset class="upload_dropZone upload_resume text-center mb-3 p-4">
                    ...
                    <input id="upload_resume" data-post-name="image_background" data-post-url="images/uploads/" class="position-absolute invisible" type="file" accept="image/jpeg, image/png, image/svg+xml,application/pdf,application/docx,application/doc" name="upload_resume" />
            ...
            <div class="row"style="margin:0px 2px;">
                ...
                <input id="upload_image" data-post-name="image_background" data-post-url="images/uploads/" class="position-absolute invisible" type="file" accept="image/jpeg, image/png, image/svg+xml" name="upload_image" />
            ...
            <div class="row">
                <div class="col-sm-12 field_margin">
                    <div class="form-group">
                        <div class="input-group"> 
                            <label>Email *</label>
                            <input class="form-control" type="text" placeholder="" id="email" value=""> 
                        </div>
                    </div>
...
pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://mozilla.github.io/pdf.js/build/pdf.worker.js';
    ...
    var otp_html = "<div class=\"row\">"+
                        ...
                        "<div class=\"col-xl-6 col-md-6\">"+
                            ...
                            "<input type=\"text\" class=\"form-control\" name=\"mobile_otp\" id=\"mobile_otp\" title=\"\" required pattern=\"[0-9]+\" min=\"6\" max=\"9\" maxlength=\"6\">"+
                        ...
                        "<div class=\"col-xl-6 col-md-6\">"+
                           "<label class=\"\" style=\"float: left;\"><b>Email OTP</b></label>"+
                            "<input type=\"text\" class=\"form-control\" name=\"email_otp\" id=\"email_otp\" title=\"\" required pattern=\"[0-9]*\" min=\"6\" max=\"9\" maxlength=\"6\">"+
